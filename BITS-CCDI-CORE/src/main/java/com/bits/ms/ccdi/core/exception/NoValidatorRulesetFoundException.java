...
/**
 * An exception that is thrown when there is no Validator Ruleset Component
 * found for the given CCDI Request. </br>
 * <p>
 * Each NoValidatorRulesetFoundException provides several kinds of
 * information:</br>
 * <ul>
 * <li>E3ErrorMessage, containing the description of the error</li>
 * <li>cause, the underlying reason for the this
 * NoValidatorRulesetFoundException</li>
 * </ul>
 *
...
public class NoValidatorRulesetFoundException extends CCDCoreException {

	/**
	 * Constructs a NoValidatorRulesetFoundException object with the given
	 ...
	 *            NoValidatorRulesetFoundException (which is saved for later
	 ...
	 */
	public NoValidatorRulesetFoundException(String errorSummary, Throwable cause) {
		super(errorSummary, cause);
	}

	/**
	 * Constructs a NoValidatorRulesetFoundException object
	 */
	public NoValidatorRulesetFoundException(String message) {
		super(message);
	}
